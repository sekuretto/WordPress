...
function portfolios_post_type() {
	...
	$labels = array(
		'name'                  => _x( 'Työnäytteet', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Työnäyte', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Portfolio', 'text_domain' ),
		'name_admin_bar'        => __( 'Post Type', 'text_domain' ),
		'archives'              => __( 'Item Archives', 'text_domain' ),
		'attributes'            => __( 'Item Attributes', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'Kaikki työnäytteet', 'text_domain' ),
		'add_new_item'          => __( 'Lisää uusi työnäyte', 'text_domain' ),
		'add_new'               => __( 'Lisää uusi työnäyte', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'työnäyte', 'text_domain' ),
		'description'           => __( 'Portfolion kuvaus', 'text_domain' ),
		'labels'                => $labels,
